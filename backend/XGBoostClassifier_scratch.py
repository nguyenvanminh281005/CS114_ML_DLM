...
# model = XGBoostClassifier(n_estimators=10, max_depth=3, learning_rate=0.1, lam=1.0, gamma=0)
...
# xgb = xgboost.XGBClassifier(n_estimators=10, max_depth=3, learning_rate=0.1, gamma=0)
